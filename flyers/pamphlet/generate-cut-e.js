// E：保成づくし（cut-e）— 保成の顔を敷き詰めた背景の上に、特大の「保成」。
...
// 実行: node flyers/pamphlet/build-pattern.js && node flyers/pamphlet/generate-cut-e.js
const L = require('./_lib');
const { pptx, slide, W, H } = L.newCut();

const INK = '1A1A1A';
const PAPER = 'FFFFFF';
const PATTERN = 'flyers/pamphlet/_assets/hosei-pattern.png';
...
L.save(pptx, 'flyers/pamphlet/cut-e.pptx');
