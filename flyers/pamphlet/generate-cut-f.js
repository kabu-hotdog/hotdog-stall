// F：保成づくし・デフォルメキャラ版（cut-f）。背景は draw-hosei.js のキャラを敷き詰めたもの。
...
const INK = '1A1A1A';
const PAPER = 'FFFFFF';
const PATTERN = 'flyers/pamphlet/_assets/hosei-pattern-chara.png';
...
L.save(pptx, 'flyers/pamphlet/cut-f.pptx');
